...
-- ============================================================
-- DB Engineer 2 — Tabel Relasi & Sistem (digabung)
-- Tabel: proker, anggota_proker, users, log_aktivitas
-- Catatan: role users hanya admin dan viewer; log_aktivitas tanpa ip_address
-- ============================================================
...
('admin_utama', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',  'admin',      NULL),
...
INSERT INTO log_aktivitas (id_user, aksi, waktu) VALUES
(1, 'Admin utama menambahkan periode kepengurusan 2024/2025',              '2024-07-01 08:00:00'),
(2, 'Admin Rizky menambahkan anggota baru: Ahmad Fauzi (NIM 2201040004)', '2024-07-15 09:30:00'),
(3, 'Admin Budi menambahkan proker: Seminar Nasional Teknologi',          '2024-08-01 10:00:00'),
(4, 'Admin Ahmad mengubah status proker OSMB menjadi selesai',            '2024-08-16 14:00:00'),
(2, 'Admin Rizky menghapus anggota: Wahyu Nugroho',                      '2024-09-05 11:20:00');
